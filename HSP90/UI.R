...
image_data <- list(
  `Castanea crenata` = list(
    paths = paste0("./Ccrenata_", 1:4, ".jpg"),
  ...
  `Castanea mollissima` = list(
    paths = paste0("./Cmollissima", 1:3, ".jpg"),
  ...
  `Quercus variabilis` = list(
    paths= paste0("./Qvariabilis", 1:3, ".jpg"),
...
shapefiles <- list(
  "Castanea crenata" = st_read("./Ccrenata.shp"),
  "Castanea dentata" = st_read("./Cdent.shp"),
  "Castanea mollissima" = st_read("./Cmolli.shp"),
  "Castanea sativa" = st_read("./SATIVA.shp"),
  "Castanopsis hystrix" = st_read("./Chystrix.shp"),
  "Quercus dentata" = st_read("./Qdent.shp"),
  "Quercus ilex" = st_read("./QilexARTICULO.shp"),
  "Quercus lobata" = st_read("./Quercus_lobata_disuelto.shp"),
  "Quercus robur" = st_read("./Querc_ROB_ART.shp"),
  "Quercus suber" = st_read("./Qerc_SUBER__ART.shp"),
  "Quercus variabilis" = st_read("./Qvari.shp")
)
# =============================================================================================
# MENU BLASTP
# =============================================================================================
