...
final_dataframe <- read.csv("./Data/final_dataframe2.csv")  #Dataframe wwith all information
        ...
        sidebar = sidebar(
          div(
            checkboxGroupInput("show_vars_protein", "Columns in Protein Database to show:",
                               choices = c("Specie","Genus","Gene", "Annotation", "Location", "Coordinates","Strand", "Protein","N. AA","Subcellular location", "Conserved domains", "GO IDs","GO Terms"),
                               selected = c("Specie","Genus","Gene", "Annotation", "Location", "Coordinates","Strand", "Protein","N. AA","Subcellular location", "Conserved domains", "GO IDs","GO Terms"))
